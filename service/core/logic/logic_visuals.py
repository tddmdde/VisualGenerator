...
async def generate_visual(username, input_dict):
    """
    Function receives the data related to the given product in order to generate the image via APITemplate
    ...
    # CHECKING WHETHER TO DRAW PRICES
    # if (price_old == price_current) or (price_old == '') or (price_old is None):
    #     price_old_visible = False
    # else:
    #     price_old_visible = True
    #     price_old, strike = await adjust_stroke(price_old)
    #
    # price_current_left, price_current_right, price_current_symbol = await adjust_prices(price_current, locale)
    #
    # vendor_logo_correlation, vendor_logo_link = await get_logo(vendor)
    #
    # if not vendor_logo_correlation:
    #     vendor_logo_visible = False
    #     vendor_logo_link = 'https://www.technodom.kz/under/feed/tddmdui/results/apitemplate/vendor_logos/Zigmund&Shtain.png'
    #     vendor_logo_correlation = 1
    # else:
    #     vendor_logo_visible = True
    #
    # api_key = '01ecNTMxNDoyMzI1OjIzd3cxQ2t4UTJzYzdVU3Q'
    # template_id = 'bc877b2b20cd2b9c'
    ...
    #         },
    #         {
    #             "name": "top_right_plashka",
    #             "src": "https://new.technodom.kz/under/feed/tddmdui/received/UploadedFile_2022-03-04104639.018930.png"
    #         },
    #         {
    #             "name": "event_name",
    ...
    #         {
    #             "name": "logo_1_1",
    #             "src": vendor_logo_link,
    #             "visible": vendor_logo_visible,
    #             "width": int(71 / vendor_logo_correlation)
    #         },
    #         {
    #             "name": "product_name",
    #             "text": title.upper(),
    ...
    #             "rectFillColor": "",
    #             "rectStrokeColor": "",
    #             "visible": price_old_visible
    #         },
    #         {
    #             "name": "price_old_strike",
    #             "text": '~' + strike + '~',
    #             "textBackgroundColor": "rgba(246, 243, 243, 0)",
    #             "color": "#fc6b3f",
    #             "rectFillColor": "",
    ...
    #         },
    #         {
    #             "name": "price_real_left",
    #             "text": price_current_left,
    #             "textBackgroundColor": "rgba(246, 243, 243, 0)",
    #             "color": "#FC6B3F"
    #         },
    #         {
    #             "name": "price_real_right",
    #             "text": price_current_right,
    #             "textBackgroundColor": "rgba(246, 243, 243, 0)",
    #             "color": "#FC6B3F"
    #         },
    #         {
    #             "name": "price_real_symbol",
    #             "text": price_current_symbol,
    #             "textBackgroundColor": "rgba(246, 243, 243, 0)",
    #             "color": "#FC6B3F"
    #         },
    #         {
    #             "name": "product_image_1_1",
    #             "stroke": "grey",
    #             "src": cropped_image,
    #             "width": int(680 / correlation),
    #             "x": 540 - int((680 / correlation) / 2)
    #         }
    #     ]
    # }
    #
    # r = requests.post(url, headers=headers, data=json.dumps(data))
    # result_link = json.loads(r.text)['download_url_png']
    #
    # df = pd.DataFrame([{
    #     "date": str(datetime.now()),
    #     "author": str(username),
    ...
    # df.to_sql('smm_generated_apitemplate_history', index=False, if_exists='append', con=conn_django)
    #
    # return {'link': result_link, 'width': f'{}','height': f'{}'}
